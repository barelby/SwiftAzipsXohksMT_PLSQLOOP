CREATE OR REPLACE TYPE T_MESSAGE_STRUCT_303_99 FORCE UNDER T_MESSAGE_STRUCT_303
(
    OVERRIDING MEMBER FUNCTION GENERATE_BODY(SELF IN OUT T_MESSAGE_STRUCT_303_99) RETURN VARCHAR2,
    ...
    CONSTRUCTOR FUNCTION T_MESSAGE_STRUCT_303_99 RETURN SELF AS RESULT
)
NOT FINAL
/
CREATE OR REPLACE TYPE BODY T_MESSAGE_STRUCT_303_99 IS

    /****************************************** OVERRIDINGS ******************************************/
    OVERRIDING MEMBER FUNCTION GENERATE_BODY(SELF IN OUT T_MESSAGE_STRUCT_303_99) RETURN VARCHAR2 IS
    BEGIN
            ...
            LOOP
                ...
                IF WORK_TEXT IS NOT NULL AND LINE_SIZE = 50 AND
                   (NEW_LINE_INDEX < 50 OR NEW_LINE_INDEX > 51) THEN
                    -- if work_text is not null and line_size=50 and new_line_index<>50 then
    ...
    CONSTRUCTOR FUNCTION T_MESSAGE_STRUCT_303_99
