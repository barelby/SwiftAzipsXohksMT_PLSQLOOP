CREATE OR REPLACE TYPE T_MESSAGE_STRUCT_301_99 FORCE UNDER T_MESSAGE_STRUCT_304
(
    OVERRIDING  MEMBER FUNCTION COMPLETE(SELF IN OUT T_MESSAGE_STRUCT_301_99)  RETURN BOOLEAN,
    OVERRIDING MEMBER FUNCTION GET_FILE_EXTENSION RETURN VARCHAR2,
    OVERRIDING MEMBER FUNCTION GET_FILE_DIR RETURN VARCHAR2,
    OVERRIDING MEMBER FUNCTION GENERATE_BODY(SELF IN OUT T_MESSAGE_STRUCT_301_99) RETURN VARCHAR2,
    ...
    CONSTRUCTOR FUNCTION T_MESSAGE_STRUCT_301_99(POBJ IN OUT NOCOPY T_INTERBANKPAYMENTS_EXTEND)
        RETURN SELF AS RESULT,
    CONSTRUCTOR FUNCTION T_MESSAGE_STRUCT_301_99 RETURN SELF AS RESULT
)
NOT FINAL
/
CREATE OR REPLACE TYPE BODY T_MESSAGE_STRUCT_301_99 IS

    /****************************************** OVERRIDINGS ******************************************/
    OVERRIDING  MEMBER FUNCTION COMPLETE(SELF IN OUT T_MESSAGE_STRUCT_301_99)  RETURN BOOLEAN IS 
    ...
    OVERRIDING MEMBER FUNCTION GENERATE_BODY(SELF IN OUT T_MESSAGE_STRUCT_301_99) RETURN VARCHAR2 IS
    BEGIN
        RETURN SELF.SMART_LN(SELF.TAG_20) || SELF.SMART_LN(SELF.TAG_21) || TRIM(SELF.SMART_LN(SELF.TAG_79));
    END;
